        ...
        >
          <div className="relative mt-[4rem] ml-[1rem] z-30 ">
            ...
            >
              ...
              AI-powered document management tool that streamlines data
              extraction and retrieval from custom data sources, such as PDFs,
              CSVs, and text files. Users can effortlessly search, organize, and
              interact with their documents, enhancing productivity and
        ...
        >
          <div className="section2-content flex flex-col items-center justify-center gap-4">
            ...
            <p className="px-[.5rem] md:px-[6rem] text-center text-zinc-500 ">
              ...
              simple, thanks to ChatDoc. Our user-friendly interface ensures
              quick and efficient communication with your PDF, SVG, TXT files.
            </p>
